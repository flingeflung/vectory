...
class ImportProjectsFromVietto extends Command
{
    ...
    public function handle(): int
    {
        ...
        // Stamm-ID (Ralf, 2026-09-20): Viettos Versionsketten (gleiche Mat.-Nr./ODN),
        // siehe ViettoVersionChains. Projekte ohne Nummer starten eine eigene Kette
        // (Vergabe im ProjectObserver).
        $stammByPn = ViettoVersionChains::build($rows, $tenant->id);
            ...
            Project::updateOrCreate(
                ...
                ($stammByPn[$row->pn] ?? []) + [
                    ...
                    'attributes' => array_filter([
                        ...
                        // Kundenversion (Zusatzfeld, Freitext); Viettos -1 heißt "nicht gesetzt".
                        'kundenversion' => $row->intVersion !== null && (int) $row->intVersion >= 0 ? (string) $row->intVersion : null,
                        'farbe' => $row->intFarbe,
