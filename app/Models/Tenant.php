...
#[Fillable(['name', 'short_name', 'project_path', 'arbeitsverzeichnis_path', 'notification_email', 'max_project_copies', 'gantt_max_projects', 'jobload_time_grid', 'default_weekly_hours', 'is_home_tenant'])]
