...
<div x-data="{ show: false }" class="relative">
    <input
        ...
        @disabled($disabled)
        {{ $attributes->merge(['class' => 'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full pr-9']) }}
    >
    <button
        type="button"
        @click="show = !show"
        ...
        :aria-label="show ? '{{ __('Passwort verbergen') }}' : '{{ __('Passwort anzeigen') }}'"
    >
