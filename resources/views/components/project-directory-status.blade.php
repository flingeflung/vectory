...
>
    @switch($status['status'])
        @case('found')
            ...
            >
                <img x-show="!copied" src="{{ asset('images/directory-status/copy2clipboard.png') }}" alt="" class="h-4 w-auto">
                <img x-show="copied" x-cloak src="{{ asset('images/directory-status/copy2clipboard_ok.png') }}" alt="" class="h-4 w-auto">
            </button>
            <button
                type="button"
            ...
            >
                <img src="{{ asset('images/directory-status/'.($status['archived'] ? 'show_dircontentArchiv.png' : 'show_dircontent.png')) }}" alt="" class="h-4 w-auto">
            </button>
        @break
