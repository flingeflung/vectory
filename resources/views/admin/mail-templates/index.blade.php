<x-admin-layout>
    ...
    <div class="max-w-2xl" x-data x-init="window.adminPageIsDirty = () => window.__mailTemplatesDirtyForms.size > 0">
        <div class="rounded-lg border border-gray-200 bg-white p-4">
            ...
            <p class="mb-3 text-xs text-gray-400">{{ __('Textbausteine mit einfügbaren Projekt-Feldern. Wer die Vorlage wo verwendet und an wen sie geht, wird erst im jeweiligen Anwendungsfall festgelegt.') }}</p>
