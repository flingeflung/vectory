@php
    ...
    $fieldHints = [
        ...
        'version' => __('Angehakt: Die Kundenversion wird beim Kopieren als neues Dokument übernommen. Beim Aufversionieren wird sie immer um 1 erhöht (letzte Zahl im Text), unabhängig vom Haken.'),
